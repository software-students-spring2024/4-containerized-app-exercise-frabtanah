...
class TestMood:
    ...
    def test_return_tip_from_specified_category(self):
        ...
        for category in relaxation_tips.keys():
            ...
            assert (
                tip in relaxation_tips[category]
            ), f"The tip should be from the {category} category."
    ...
    def test_return_tip_with_no_category(self):
        ...
        assert (
            tip in all_tips
        ), "The function should return a valid tip when no category is specified."
    ...
    def test_relaxation_tip_variety(self):
        ...
        unique_tips = set(
            tips
        )  # convert the list of tips to a set to remove duplicates
    ...
    def test_cat_mood_generator(self):
        ...
        assert (
            mood in expected_moods
        ), f"The mood {mood} is not in the list of expected moods."
